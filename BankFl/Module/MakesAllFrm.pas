...
uses
  ...
  RxMemDS, Btrieve, TimerLst, Common, Basbn, Registr, Utilits,
  CommCons, BankCnBn, BUtilits;
...
begin 
  ...
  PrintDocRec.GraphForm := DecodeMask('$(AccSheetGraphForm)', 5, GetUserNumber);
  PrintDocRec.TextForm := DecodeMask('$(AccSheetTextForm)', 5, GetUserNumber);
end;
    ...
    begin
      ...
      begin
        ...
        begin
          ...
          begin
            MessageBox(Handle, PChar('Ошибка остатка по счету '+StrPas(pac^.acNumber)+
