...
uses
  ...
  BankCnBn,
  CommCons,
  AbonsFrm in 'AbonsFrm.pas' {AbonsForm},
  AbonFrm in 'AbonFrm.pas' {AbonForm},
  AbonStatFrm in 'AbonStatFrm.pas' {AbonStatForm},
  AbonSidFrm in 'AbonSidFrm.pas' {AbonSidForm};
...
begin
  ...
  if AbonsForm=nil then
    AbonsForm := TAbonsForm.Create(Sender as TComponent)
  else
    AbonsForm.Show;
end;
...
begin
  ...
  with Result do begin
    Caption:='А&боненты';
    Hint:='Показывает список абонентов';
