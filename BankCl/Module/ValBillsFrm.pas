...
uses
  ...
  StdCtrls, Buttons, ComCtrls, SearchFrm, Sign, PaydocsFrm, Common, Bases,
  Utilits, CommCons, DateFrm;

type
  TValBillsForm = class(TDataBaseForm)
...
var
  ValBillsForm: TValBillsForm;

implementation

{$R *.DFM}

procedure TValBillsForm.FormCreate(Sender: TObject);
begin
...
procedure TValBillsForm.FormDestroy(Sender: TObject);
begin
  ValBillsForm := nil;
end;

procedure TValBillsForm.NameEditChange(Sender: TObject);
var
  I, Err: LongInt;
  D: Word;
begin
...
procedure TValBillsForm.FindItemClick(Sender: TObject);
begin
  SearchForm.ShowModal;
end;

procedure TValBillsForm.FormClose(Sender: TObject; var Action: TCloseAction);
begin
  if FormStyle=fsMDIChild then Action:=caFree;
end;

procedure TValBillsForm.SeeItemClick(Sender: TObject);
var
  I: Integer;
begin
