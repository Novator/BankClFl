...
begin
  ...
  AList.Add('6=*Инкассовое поручение (до 1 июня 03)');
  ...
  begin
    ...
    begin
      ...
      case PayRecPtr^.dbDoc.drType of
        2: Caption := 'Платежное требование (до 1 июня 03)';
        6: Caption := 'Инкассовое поручение (до 1 июня 03)';
        16: Caption := 'Платежный ордер (до 1 июня 03)';
        else
