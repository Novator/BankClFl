...
uses
  ...
  SignedDocsFrm in 'SignedDocsFrm.pas' {SignedDocsForm},
  StatusFrm in 'StatusFrm.pas' {StatusForm};
...
begin
  ...
  begin
    ...
    MessageBox(ParentWnd, 'Не удалось открыть список модулей',
