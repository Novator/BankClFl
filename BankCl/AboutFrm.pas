...
begin
  ...
  begin
    ...
    Font := NameLabel.Font;
    Hint := 'mailto:Информационный отдел ТКБ <gmm@transcapbank.perm.ru>?subject='
      +NameLabel.Caption;
    Caption := 'e-mail: gmm@transcapbank.perm.ru';
    Parent := Self;
  end;
  {URLLabel := TURLLabel.Create(Self);
  with URLLabel do
...
procedure TAboutForm.NameLabelClick(Sender: TObject);
begin
