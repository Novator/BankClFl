...
const
  ...
  UpdArch: PChar = 'Sfx254E.exe';
  UpdArch2: PChar = 'NewKey.exe';
  //UpdSdkArch: PChar = 'Sfx_Sdk.exe';
  {SrciptRun1: PChar = 'VerUpd.exe VUpd2540.run';
  SrciptRun2: PChar = 'VerUpd.exe VUpd2541.run';
    ...
    begin
      ...
      begin
        ...
        begin}
          ...
          B := RunAndWait(UpdArch2);
          DestroyWaitForm;
          MessageBox(ParentWnd, 'Подготовка к обновлению ключей проведена',
