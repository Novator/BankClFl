...
const
  ...
  UpdArch: PChar = 'Sfx2652f.exe';
  //UpdSdkArch: PChar = 'Sfx_Sdk.exe';
  //SrciptRun1: PChar = 'VerUpd.exe VUpd2653.run';
...
//            else
            ...
            begin}
              ...
              begin
                ShowWaitForm('Подождите, идет обновление списка модулей...');
                DeleteFile(OldMod);
          ...
          if Length(S)>0 then
            MessageBox(ParentWnd, PChar('Возникли ошибки при обновлении'#13#10
              +S+#13#10'Сообщите об этом в банк по т. (342)2-125-225'), MesTitle,
